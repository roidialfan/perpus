        ...
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
                            ...
                            <li><a href="#">kategori</a>
                                <div class="megamenu">
                                    ...
                                    <ul class="single-mega cn-col-4">
                                        ...
                                        <li><a href="shop.html">Komputer & Teknologi</a></li>
                                        <li><a href="shop.html">Komik & Cerpen</a></li>
                                        <li><a href="shop.html">Agama</a></li>
                                        <li><a href="shop.html">Pendidikan</a></li>
                                    </ul>
                                    </div>
                            </li>
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="user-login-info">
                    <a href="<?php echo base_url()?>c_login/logout">sign out</a>
                </div>
                <!-- Cart Area -->
                <div class="cart-area">
            ...
            <div class="cart-list">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="<?php echo base_url()?>asset/img/product-img/product-1.jpg" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="<?php echo base_url()?>asset/img/product-img/product-2.jpg" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                          <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                            <span class="badge">Mango</span>
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="<?php echo base_url()?>asset/img/product-img/product-3.jpg" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                          <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                            <span class="badge">Mango</span>
